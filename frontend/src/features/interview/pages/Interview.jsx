  ...
  if (loading || !report) {
    return (
      <main className="loading-screen">
        <h1>{error ? error : "Loading your interview plan..."}</h1>
      </main>
    );
  }
    ...
    <div className="interview-page">
      <div className="interview-layout">
        <nav className="interview-nav">
          ...
          <button onClick={() => getResumePdf(interviewId).catch((error) => { console.error(error); })} className="button primary-button">
            Download Resume
          </button>
        </nav>
        ...
        <aside className="interview-sidebar">
          <div className="match-score">
            ...
            <p className="match-score__sub">{report.title}</p>
          </div>
