  ...
  return (
    <div className="home-page">
      <header className="page-header">
        ...
        <p>Let AI analyze the job requirements and your profile to build a focused interview strategy.</p>
      </header>
      ...
      <div className="interview-card">
        ...
        <div className="interview-card__footer">
          ...
          <button disabled={loading} onClick={handleGenerateReport} className="generate-btn">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l2.4 7.4H22l-6.2 4.5 2.4 7.4L12 17l-6.2 4.3 2.4-7.4L2 9.4h7.6z" /></svg>
            {loading ? "Generating..." : "Generate My Interview Strategy"}
          </button>
        </div>

        {error ? <p className="form-error" style={{ padding: "0 1.5rem 1.5rem" }}>{error}</p> : null}
      </div>
